...
class BlockUserService(private val blockUserRepository: BlockUserRepository) {
    ...
    fun blockExists(profile: ProfileModel, profileBLock: ProfileModel): List<BlockUserModel> {
        return this.blockUserRepository.findBlockUserModelByProfileIdAndProfileIdBlock(profile, profileBLock)
    }
}